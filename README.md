...
- The `LegalParticipant` credential referenced in the Trust Framework 22.10 obviously has a different shape one than the one that is accepted by the current [Compliance Service](https://compliance.lab.gaia-x.eu/main/docs). 
